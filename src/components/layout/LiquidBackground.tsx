...
export function LiquidBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      {/* Decorative Grid - styled exactly like maintenance mode but animated */}
      <div className="absolute inset-0 bg-grid-moving [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none" />
