...
export function FAQ() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-[var(--text-secondary)] font-sans">
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <Link to="/" className="inline-flex items-center gap-2 text-sm font-bold text-blue-500 hover:text-blue-400 mb-8 transition-colors">
            <ArrowLeft className="w-4 h-4" /> Back to Home
          </Link>
          <h1 className="text-5xl md:text-6xl font-black text-[var(--text-primary)] mb-6 tracking-tight italic">
            Frequently Asked <span className="text-blue-500">Questions</span>
          </h1>
          <p className="text-xl max-w-2xl mx-auto leading-relaxed font-medium">
        ...
        >
          ...
          <a
            href="mailto:dexcaptch@gmail.com"
            className="inline-flex h-14 items-center px-10 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl shadow-lg shadow-blue-500/20 transition-all hover:scale-105 active:scale-95"
          >
            Contact Support
          </a>
        </motion.div>
